...
class EventtypeConfigForm extends RepositoryForm
{
    public function init()
    {
        ...
        $this->redirectUrl = 'splunk/eventtypes';
    }
    ...
    protected function onUpdateSuccess()
    {
        if ($this->getElement('btn_remove')->isChecked()) {
            $this->setRedirectUrl("splunk/eventtypes/delete?eventtype={$this->getIdentifier()}");
            $success = true;
        } else {
    ...
    protected function createBaseElements(array $formData)
    {
        ...
        $this->addElement(
            ...
            'instance',
            array(
                'description'   => $this->translate('Splunk instance'),
                'label'         => $this->translate('Splunk Instance'),
        ...
        $this->addElement(
            ...
            'index',
            array(
                'description'   => $this->translate('Splunk index pattern'),
        ...
        $this->addElement(
            ...
            'filter',
            array(
                'description'   => $this->translate('Splunk filter in the Icinga Web 2 filter format'),
