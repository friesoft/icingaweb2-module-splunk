...
namespace Icinga\Module\Splunk\Clicommands;
...
class CheckCommand extends Command
{
    ...
    /**
     * Count Splunk events in a certain time period and report warning or critical according to the given thresholds
     *
     * USAGE:
     *
     *   icingacli splunk check [options]
     *
     * OPTIONS:
     *
     *   --instance     Name of the configure Splunk instace
     *
     *   --index        Splunk index pattern
     *
     *   --filter       Splunk filter in the Icinga Web 2 URL filter format
     *
