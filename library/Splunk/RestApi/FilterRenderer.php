<?php
/* Splunk Module | (c) 2016 Icinga Development Team | GPLv2+ */
 ...
 *
 * Provides Rendering of Icingaweb2 filters to an Splunk query.
 *
 * Obviously this class is limited to the feature set of Icinga\Data\Filter\Filter.
 *
 * @package Icinga\Module\Splunk
 */
class FilterRenderer {
    ...
    public function setFilter(Filter $filter)
    {
        ...
        Logger::debug('Rendered splunk filter: %s', json_encode($this->query));
        return $this;
    }
    ...
    /**
     * Renders the Splunk query as a recursive function, walking through the FilterChain.
     *
